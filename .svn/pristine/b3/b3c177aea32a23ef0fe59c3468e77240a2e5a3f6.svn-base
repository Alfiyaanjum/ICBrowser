<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SellersRatingforBuyer.aspx.cs" Inherits="ICBrowser.Web.SellersRatingforBuyer"
                                    ...
                                    <tr>
                                        <td width="80%">
                                            <table width="100%" cellspacing="3" cellpadding="3">
                                                <tr>
                                                    <td>
                                                        4.&nbsp;&nbsp;<asp:Label ID="lblQuestion4" runat="server" Font-Size="12px" Font-Italic="True"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" width="50%">
                                                        <asp:Button ID="btnCancel" runat="server" Text="Cancel" CausesValidation="false"
                                                            CssClass="blue_button" OnClick="btnCancel_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
