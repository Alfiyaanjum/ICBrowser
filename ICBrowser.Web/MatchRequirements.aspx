<%@ Page Language="C#" Title="ICBrowser.com buy and sell electronic components" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="MatchRequirements.aspx.cs"
    Inherits="ICBrowser.Web.MatchOffers" Culture="auto" UICulture="auto" meta:resourcekey="PageResource1" %>
            ...
            <table class="headerback" width="100%">
                <tr>
                    <td colspan="3">
                        <div class="headerback">
                            <asp:Label ID="lblHeader" runat="server" Text="Match components from Requirement/PO database with my posted Offers/Inventories"
                ...
                <tr>
                    ...
                    <td width="20%" align="center">
                        <asp:Button ID="btnSendMsg" runat="server" Text="Send Message" Visible="False" CssClass="blue_button"
                            meta:resourcekey="btnSendMsgResource1" OnClick="btnSendMsg_Click" />
                    </td>
                </tr>
            </table>
        </div>
                            ...
                            <tr>
                                ...
                                <td width="20%" align="center">
                                    <asp:Button ID="btnSendMsg" runat="server" Text="Send Message" CommandArgument='<%# Eval("UserId") %>'
                                        CommandName="Send" CssClass="blue_button" meta:resourcekey="btnSendMsgResource2" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3">
                                    <div class="grid">
                                        <asp:GridView ID="MatchOffer" runat="server" AutoGenerateColumns="False" DataSource='<%# Eval("Requirements") %>'
                                            OnRowCommand="MatchOffer_RowCommand" Width="100%" CssClass="table-border" meta:resourcekey="MatchOfferResource1">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="CreationDate" DataFormatString="{0:dd-MMM-yyyy}" HeaderText="Posted On"
                                                    SortExpression="CreationDate" meta:resourcekey="BoundFieldResource24">
                                                    <HeaderStyle Width="10%" />
                                                </asp:BoundField>
                                            </Columns>
                ...
                <tr class="pagination" align="center">
                    <td>
                        <cc:PagerV2_8 ID="pagerForRepeater" PageSize="50" runat="server" OnCommand="pager_Command"
                            ...
                            BackToPageClause="Back to Page" CompactModePageCount="0" CurrentIndex="1" FirstClause="&amp;lt;&amp;lt;"
