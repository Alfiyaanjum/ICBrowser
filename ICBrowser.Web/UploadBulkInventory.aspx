<%@ Page Title="ICBrowser.com buy and sell electronic components" Language="C#" MasterPageFile="~/Detail.Master"
    AutoEventWireup="true" CodeBehind="UploadBulkInventory.aspx.cs" Inherits="ICBrowser.Web.UploadBulkInventory"
                            ...
                            <table style="width: 100%" cellspacing="0" cellpadding="0">
                                <tr style="height: 8px">
                                    <td style="width: 100%" align="left">
                                        <asp:Label ID="lblUploadMessage" runat="server" CssClass="greenmsg"></asp:Label>
                                        <asp:Label ID="lblExcessMessage" runat="server" CssClass="redmsg"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td align="left">
                            <div class="headerback">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Label ID="lblgrdheading" runat="server" CssClass="header" Text="Post your inventories in the given form"
